    ...
    <div style={{background:'#f8fafc',color:'#0f172a',minHeight:'100vh',fontFamily:"'Noto Sans KR',sans-serif",overflowX:'hidden'}}>
      ...
      <nav style={{position:'sticky',top:0,zIndex:100,background:'rgba(248,250,252,0.92)',backdropFilter:'blur(16px)',borderBottom:'1px solid #e2e8f0',padding:'0 20px'}}>
        <div style={{maxWidth:'800px',margin:'0 auto',display:'flex',alignItems:'center',justifyContent:'space-between',height:'54px'}}>
          <div style={{fontSize:'17px',fontWeight:900,letterSpacing:'-1px',color:'#0f172a'}}>
            TRAINER<span style={{color:'#84cc16'}}>LOG</span>
          </div>
          <div style={{display:'flex',gap:'8px',alignItems:'center'}}>
            <Link to="/trainer" style={{fontSize:'13px',fontWeight:600,padding:'7px 15px',borderRadius:'8px',background:'#0f172a',color:'#fff',textDecoration:'none'}}>트레이너 앱</Link>
            <Link to="/member" style={{fontSize:'13px',fontWeight:600,padding:'7px 15px',borderRadius:'8px',background:'#c8f135',color:'#111',textDecoration:'none'}}>회원 포털</Link>
          </div>
        </div>
      </nav>
      ...
      <footer style={{background:'#0a0f1a',borderTop:'1px solid #1e293b',padding:'28px 24px',textAlign:'center'}}>
        <div style={{fontSize:'15px',fontWeight:900,letterSpacing:'-0.5px',marginBottom:'14px',color:'#334155'}}>
          TRAINER<span style={{color:'#84cc16'}}>LOG</span>
        </div>
