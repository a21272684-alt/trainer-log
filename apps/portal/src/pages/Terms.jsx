  ...
  return (
    <>
      <div style={S.section}>
        ...
        {/* BETA HIDDEN — community/CRM 미공개 (2026-05-21~) · 정식 출시 시 "피트니스 관리·커뮤니티·센터 운영(CRM) 플랫폼" 으로 원복 */}
        <p style={S.p}>본 약관은 <strong>이루스케일즈</strong>(대표 윤준현, 이하 "회사")가 제공하는 <strong>오운</strong> 피트니스 관리 플랫폼(이하 "서비스")의 이용 조건 및 절차, 회사와 이용자 간의 권리·의무·책임 사항을 규정함을 목적으로 합니다.</p>
      </div>
      ...
      <div style={S.section}>
        ...
        {/* BETA HIDDEN — community/CRM 미공개 (2026-05-21~) · 정식 출시 시
            (1) 위 info 박스 (베타 단계 적용 범위) 주석 해제
            (2) "서비스" 정의에 ", 커뮤니티 포털, 헬스장 운영자 포털" 추가
            (3) 아래 2개 li (커뮤니티 이용자, 헬스장 운영자) 주석 해제
        */}
        {/* BETA HIDDEN:
        <div style={S.info}>
        ...
        */}
        <ul style={S.ul}>
          <li style={S.li}><strong>"서비스"</strong>란 회사가 제공하는 트레이너 포털, 회원 포털 및 부속 기능 일체를 말합니다.</li>
          ...
          {/* BETA HIDDEN: <li style={S.li}><strong>"커뮤니티 이용자"</strong>란 커뮤니티 포털 가입자를 말합니다.</li> */}
          {/* BETA HIDDEN: <li style={S.li}><strong>"헬스장 운영자"</strong>란 CRM 포털을 통해 센터를 관리하는 대표자를 말합니다.</li> */}
      ...
      <div style={S.section}>
        ...
        {/* BETA HIDDEN — community/CRM 미공개 (2026-05-21~) · 정식 출시 시
            (1) 트레이너/회원 포털 li 에서 "(✓ 베타 운영 중)" em 라벨 제거
            (2) 커뮤니티 포털 / 헬스장 운영자 CRM 포털 li 주석 해제 (단, 라벨 제거)
            (3) 아래 ⚠️ "준비 중" 안내 박스 주석 해제 (또는 정식 출시 시 불필요하면 삭제)
        */}
        <ul style={S.ul}>
          ...
          {/* BETA HIDDEN: <li style={S.li}><strong>커뮤니티 포털</strong>: 게시글 작성·열람, 트레이너 간 정보 교류, 운동 루틴 등 디지털 콘텐츠의 등록·교환.</li> */}
          {/* BETA HIDDEN: <li style={S.li}><strong>헬스장 운영자(CRM) 포털</strong>: 소속 트레이너·회원 통계, 정산 운영, 주간 운영 리포트.</li> */}
        </ul>
      ...
      {/* BETA HIDDEN — community 미공개 (2026-05-21~) · 정식 출시 시 아래 제7조 주석 해제 + 이하 제7~13조를 제8~14조로 원복 (현재는 제7조 누락 상태로 번호 연속성 유지)
      <div style={S.section}>
      ...
      */}
      ...
      <div style={S.section}>
        ...
        <ul style={S.ul}>
          ...
          {/* BETA HIDDEN: <li style={S.li}>커뮤니티에 음란·차별·허위·광고성·도배성 게시물을 작성하지 않습니다.</li> */}
        </ul>
      </div>

      <div style={S.section}>
        <h2 style={S.h2}>제8조 (서비스 이용 제한)</h2>
      ...
      <div style={S.section}>
        ...
        <ul style={S.ul}>
          ...
          {/* BETA HIDDEN — CRM 미공개 (2026-05-21~) · 정식 출시 시 "회원·트레이너·헬스장 운영자" 로 원복 */}
          <li style={S.li}>회사는 회원·트레이너 간 발생한 사적 분쟁에 대해 직접 당사자가 아니므로 책임을 지지 않습니다.</li>
          <li style={S.li}>회사는 이용자가 자발적으로 작성·게시한 콘텐츠의 적법성·정확성에 대해 책임을 지지 않습니다.</li>
        </ul>
      </div>

      <div style={S.section}>
        <h2 style={S.h2}>제10조 (지식재산권)</h2>
      ...
      <div style={S.section}>
        <h2 style={S.h2}>제11조 (고객 지원 채널)</h2>
