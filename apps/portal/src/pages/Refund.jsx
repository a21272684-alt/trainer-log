...
function FallbackRefund() {
  return (
    <>
      ...
      {/* BETA HIDDEN — community 미공개 (2026-05-21~) · 정식 출시 시 아래 제4조 주석 해제 + 이하 제4~5조를 제5~6조로 원복 (현재는 제4조 누락 상태로 번호 연속성 유지)
      <div style={S.section}>
      ...
      */}
      ...
      <div style={S.section}>
        <h2 style={S.h2}>제4조 (환불·문의 신청 채널)</h2>
